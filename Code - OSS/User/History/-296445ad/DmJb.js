...
function calculateTaskScore(date) {
    console.log(`[calculateTaskScore] Called for date: ${date}`);
    return new Promise((resolve, reject) => {
        ...
        db.get(completedSql, [date], (err, completedRow) => { // Only need 'date' once here
            ...
            console.log(`[calculateTaskScore] For ${date}: num_completed_today = ${num_completed_today}`);
            db.get(assignedSql, [date], (err, assignedRow) => {
                ...
                console.log(`[calculateTaskScore] For ${date}: num_assigned_for_today = ${num_assigned_for_today}`);
                ...
                console.log(`[calculateTaskScore] For ${date}: resolving with task_score_raw = ${task_score_raw}`);
