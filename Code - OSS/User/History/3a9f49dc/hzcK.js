...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // const viewAllTasksBtn = document.getElementById('view-all-tasks-btn'); // If you have this
    ...
    // --- View Management (as before, but ensure it exists) ---
    function showView(viewIdToShow) {
        ...
        if (activeSection) {
            ...
            if (viewIdToShow === 'history-section' && window.chartJsModule && typeof window.chartJsModule.initializeOrRefreshCharts === 'function') {
                console.log("app.js: Calling initializeOrRefreshCharts for history section.");
                window.chartJsModule.initializeOrRefreshCharts(); // This will now call the updated initializeHistoryPage
            } else if (viewIdToShow === 'habits-management-section' && window.habitManagementModule && typeof window.habitManagementModule.initializeHabitManagementPage === 'function') {
    ...
    // Edit Task Modal Form Submission (if you move this logic from task.js)
    if (editTaskForm) {
    ...
    if (manageHabitsBtn) manageHabitsBtn.addEventListener('click', () => showView('habits-management-section'));
    if (gotoTimetrackerBtn) gotoTimetrackerBtn.addEventListener('click', () => showView('timetracker-section'));
    if (gotoHistoryBtn) gotoHistoryBtn.addEventListener('click', () => showView('history-section'));
    if (gotoDataMgmtBtn) gotoDataMgmtBtn.addEventListener('click', () => showView('data-management-section'));


    // Global dataChanged listener (keep as is)
