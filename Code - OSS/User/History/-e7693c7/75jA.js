...
// const taskRoutes = require('./routes/tasks.js'); // Placeholder for later
// const timeLogRoutes = require('./routes/timelogs.js'); // Placeholder for later
const app = express();
...
app.put('/api/settings', (req, res) => {
    ...
    // Basic validation (more thorough validation should be added)
    if (typeof rest_day_monday !== 'boolean' /* ... add checks for all days */) {
        return res.status(400).json({ error: "Invalid data types for rest days." });
    }
