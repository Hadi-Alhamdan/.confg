...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function handleAddHabitSubmit(event) {
        ...
        try {
            ...
            document.body.dispatchEvent(new CustomEvent('dataChanged', { detail: { date: getTodayString() /* or the date of the habit if applicable */ } }));
    ...
    async function handleHabitListClick(event) {
        ...
        if (target.classList.contains('complete-btn')) {
            ...
            try {
                ...
                // After success, reload everything to get the latest state and score.
                await loadAllHabits();
            } catch (error) {
