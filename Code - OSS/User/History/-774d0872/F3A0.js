...
if (req.body && req.body.date) {
    ...
    completionDate = getCurrentDateYYYYMMDD();
}
    ...
    db.get("SELECT current_weight FROM Habits WHERE id = ?", [habitId], (err, habit) => {
        ...
        db.run(insertSql, [habitId, completionDate, weightAtCompletion], function(err) {
            ...
            recalculateDailyScore(completionDate).catch(err => {
                console.error(`Failed to recalculate score after habit completion: ${err.message}`);
