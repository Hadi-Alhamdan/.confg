...
vim.opt.guifont = "Noto Sans Arabic:h13"
vim.keymap.set('n', '<A-t>', ':tabnew<CR>', { desc = 'Open new tab' })
vim.keymap.set('n', '<A-w>', ':tabclose<CR>', { desc = 'Close current tab' })

-- This loop creates mappings for <A-1> to <A-9> to move between tabs
for i = 1, 9 do
  vim.keymap.set('n', string.format('<A-%d>', i), string.format('%dgt', i), {
